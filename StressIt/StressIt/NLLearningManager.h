...
// Метод, возвращяет массив из NLWord * для сегодняшнего изучения. В нем могут быть только новые
// слова.
+ (NSArray *)newWordsForToday;

// Аналогичный предыдущему метод. Возвращает массив слов для теста. Может содержать как только
// что пройденные, так и слова для работы над ошибками. При ответе вызывается следующий за этим метод.
